...
try {
   ...
   // PreparedStatement s = con.prepareStatement("update customerregister set Password=?,ConfirmPassword=?,FirstName=?,LastName=?,Gender=?, Age=?,TelephoneNo=?,MobileNo=?,Email=?,Address=?,Pincode=?,AnnualIncome=?");
